...
include "../modelo/conexion.php";
        ...
        $sqlCheckAdmin = $conexion->query("SELECT ID_Admin FROM administrador WHERE (UsuarioAdmin = '$Usuario' OR Email = '$Email') AND ID_Admin != $ID");
        ...
        // Actualizar datos
        $sql = $conexion->query("UPDATE administrador SET UsuarioAdmin = '$Usuario', Nombre = '$Nombre', Email = '$Email' WHERE ID_Admin = $ID");
